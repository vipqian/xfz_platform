...
AddCourse.prototype.initUEditor = function () {
...
AddCourse.prototype.listenQnUploadFileEvent = function () {
    var self = this;
...
AddCourse.prototype.updateUploadProgress = function (response) {
    // 上传过程中做的事情
    var self = this;
    var total = response.total;
    var percent = total.percent;
    var progressGroup = AddCourse.progressGroup;
    progressGroup.show();
...
AddCourse.prototype.uploadErrorEvent = function (error) {
    var progressGroup = AddCourse.progressGroup;
    progressGroup.hide();
...
AddCourse.prototype.complateUploadEvent = function (response) {
    var progressGroup = AddCourse.progressGroup;
    progressGroup.hide();
    var progressBar = $('.progress-bar');
...
AddCourse.prototype.listenSumbitEvent = function () {
    var subBtn = $('#sub-btn');
...
$(function () {
    ...
    addCourse.run();
    AddCourse.progressGroup = $('#progress-group');
});
