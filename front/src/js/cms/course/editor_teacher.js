function EditorTeacher() {

}

EditorTeacher.prototype.run = function () {
...
// 上传文件到七牛云
EditorTeacher.prototype.listenQnUploadFileEvent = function () {
    var self = this;
...
EditorTeacher.prototype.updateUploadProgress = function (response) {
    // 上传过程中做的事情
    var self = this;
    var total = response.total;
    var percent = total.percent;
    var progressGroup = EditorTeacher.progressGroup;
    progressGroup.show();
...
EditorTeacher.prototype.uploadErrorEvent = function (error) {
    var progressGroup = EditorTeacher.progressGroup;
    progressGroup.hide();
...
EditorTeacher.prototype.complateUploadEvent = function (response) {
    var progressGroup = EditorTeacher.progressGroup;
    progressGroup.hide();
    var progressBar = $('.progress-bar');
...
EditorTeacher.prototype.listenSumbitEvent = function () {
    var subBtn = $('#sub-btn');
    subBtn.click(function (event) {
        event.preventDefault();
        var teacher_id = subBtn.attr('data-teacher-id');
...
$(function () {
    var editorTeacher = new EditorTeacher();
    editorTeacher.run();
    EditorTeacher.progressGroup = $('#progress-group');
});
